...
var vec__8928 = cljs.core.split_with(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.not_EQ_," "),link);
var link__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8928,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8928,(1),null);
...
var len__4864__auto___9110 = arguments.length;
var i__4865__auto___9111 = (0);
while(true){
if((i__4865__auto___9111 < len__4864__auto___9110)){
args__4870__auto__.push((arguments[i__4865__auto___9111]));

var G__9112 = (i__4865__auto___9111 + (1));
i__4865__auto___9111 = G__9112;
continue;
} else {
}
break;
...
(markdown.links.img.cljs$core$IFn$_invoke$arity$variadic = (function (alt,url,state,p__8943){
var vec__8944 = p__8943;
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8944,(0),null);
...
/** @this {Function} */
(markdown.links.img.cljs$lang$applyTo = (function (seq8939){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__8940,G__8941,G__8942,seq8939__$3);
}));
...
var vec__8961 = cljs.core.split_with(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.not_EQ_,"]"),xs__$1);
var alt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8961,(0),null);
var xy = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8961,(1),null);
var vec__8964 = cljs.core.split_with(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.not_EQ_,")"),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),xy));
var url_title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8964,(0),null);
var zy = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8964,(1),null);
var vec__8967 = cljs.core.split_with(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.not_EQ_," "),url_title);
var url = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8967,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8967,(1),null);
var vec__8970 = markdown.links.img.cljs$core$IFn$_invoke$arity$variadic(alt,url,state,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.not_empty(title)], 0));
var new_text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8970,(0),null);
var new_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8970,(1),null);
...
return cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__8975_SHARP_,p2__8974_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(p2__8974_SHARP_,p1__8975_SHARP_);
}),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [title,state], null),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [markdown.common.italics,markdown.common.em,markdown.common.strong,markdown.common.bold,markdown.common.strikethrough], null)));
});
markdown.links.make_link = (function markdown$links$make_link(img_QMARK_){
return (function markdown$links$make_link_$_link(text,p__8976){
var map__8977 = p__8976;
var map__8977__$1 = cljs.core.__destructure_map(map__8977);
var state = map__8977__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8977__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8977__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
...
var vec__9011 = cljs.core.split_with(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.not_EQ_,"["),tokens);
var head = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9011,(0),null);
var xs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9011,(1),null);
var vec__9014 = markdown.links.handle_img_link(xs,loop_state);
var xs__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9014,(0),null);
var loop_state__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9014,(1),null);
var vec__9017 = cljs.core.split_with(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.not_EQ_,"]"),xs__$1);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9017,(0),null);
var ys = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9017,(1),null);
var vec__9020 = cljs.core.split_with(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.not_EQ_,"("),ys);
var dud = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9020,(0),null);
var zs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9020,(1),null);
var vec__9023 = cljs.core.split_with(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.not_EQ_,")"),zs);
var link__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9023,(0),null);
var tail = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9023,(1),null);
if((((cljs.core.count(tail) < (1))) || ((((cljs.core.count(link__$1) < (2))) || ((cljs.core.count(dud) > (1))))))){
var G__9119 = cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(out,head,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([title], 0));
var G__9120 = cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(dud,link__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([tail], 0));
var G__9121 = loop_state__$1;
out = G__9119;
tokens = G__9120;
loop_state = G__9121;
continue;
...
var vec__9028 = markdown.links.href(cljs.core.rest(markdown.links.process_link_title(title,state)),cljs.core.rest(link__$1),loop_state__$1);
var link_text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9028,(0),null);
var new_loop_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9028,(1),null);
var G__9122 = cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(out,head,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([link_text], 0));
var G__9123 = cljs.core.rest(tail);
var G__9124 = new_loop_state;
out = G__9122;
tokens = G__9123;
loop_state = G__9124;
continue;
...
var vec__9031 = cljs.core.split_with(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.not_EQ_," "),cljs.core.rest(link__$1));
var url = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9031,(0),null);
var title__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9031,(1),null);
...
var vec__9034 = markdown.links.img.cljs$core$IFn$_invoke$arity$variadic(alt,url,loop_state__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([title__$2], 0));
var img_text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9034,(0),null);
var new_loop_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9034,(1),null);
var G__9125 = cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(out,cljs.core.butlast(head),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([img_text], 0));
var G__9126 = cljs.core.rest(tail);
var G__9127 = new_loop_state;
out = G__9125;
tokens = G__9126;
loop_state = G__9127;
continue;
} else {
var G__9128 = cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(out,head,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([title,dud,link__$1], 0));
var G__9129 = tail;
var G__9130 = loop_state__$1;
out = G__9128;
tokens = G__9129;
loop_state = G__9130;
continue;
...
var vec__9043 = clojure.string.split.cljs$core$IFn$_invoke$arity$3(reference,/\]\s*/,(2));
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9043,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9043,(1),null);
var vec__9046 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(references,id);
var link = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9046,(0),null);
var alt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9046,(1),null);
...
return cljs.core.second(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__9053,link){
var vec__9054 = p__9053;
var i__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9054,(0),null);
var encoded = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9054,(1),null);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__9058){
var vec__9059 = p__9058;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9059,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9059,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (s,p__9062){
var vec__9063 = p__9062;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9063,(0),null);
var link = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9063,(1),null);
...
markdown.links.reference_link = (function markdown$links$reference_link(text,p__9066){
...
var references = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9067__$1,new cljs.core.Keyword(null,"references","references",882562509));
...
markdown.links.replace_all_footnote_links = (function markdown$links$replace_all_footnote_links(text,p__9072){
while(true){
var map__9073 = p__9072;
var map__9073__$1 = cljs.core.__destructure_map(map__9073);
var state = map__9073__$1;
var footnotes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9073__$1,new cljs.core.Keyword(null,"footnotes","footnotes",-1842778205));
...
var G__9136 = next_text;
var G__9137 = next_state;
text = G__9136;
p__9072 = G__9137;
continue;
}
...
var vec__9078 = markdown.links.replace_all_footnote_links(text,state);
var text__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9078,(0),null);
var state__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9078,(1),null);
...
markdown.links.image_reference_link = (function markdown$links$image_reference_link(text,p__9085){
var map__9086 = p__9085;
var map__9086__$1 = cljs.core.__destructure_map(map__9086);
var state = map__9086__$1;
var references = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9086__$1,new cljs.core.Keyword(null,"references","references",882562509));
...
while(true){
if(cljs.core.seq(ms)){
var vec__9097 = cljs.core.first(ms);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9097,(0),null);
var alt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9097,(1),null);
var ref = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9097,(2),null);
