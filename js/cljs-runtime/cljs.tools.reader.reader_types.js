...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_9223 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_9223(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_9224 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_9224(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_9225 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_9225(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_9226 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_9226(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_9227 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_9227(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_9228 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_9228(reader);
}
});
...
var G__9254 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__9255 = s.append(c);
c = G__9254;
s = G__9255;
continue;
}
