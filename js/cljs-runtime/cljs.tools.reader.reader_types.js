...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_9309 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_9309(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_9310 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_9310(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_9311 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_9311(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_9319 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_9319(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_9322 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_9322(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_9323 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_9323(reader);
}
});
...
var G__9355 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__9356 = s.append(c);
c = G__9355;
s = G__9356;
continue;
}
