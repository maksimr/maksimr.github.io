...
args__4870__auto__.push((arguments[i__4865__auto___8910]));

var G__8912 = (i__4865__auto___8910 + (1));
i__4865__auto___8910 = G__8912;
continue;
} else {
}
break;
...
/** @this {Function} */
(markdown.common.freeze_string.cljs$lang$applyTo = (function (seq8843){
...
var G__8914 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (text,state,matches,temp__5751__auto__){
return (function (s,r){
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560).cljs$core$IFn$_invoke$arity$1(state),p1__8849_SHARP_,p1__8849_SHARP_);
});})(text,state,matches,temp__5751__auto__))
);
});})(text,state,matches,temp__5751__auto__))
,text,matches);
var G__8915 = cljs.core.update.cljs$core$IFn$_invoke$arity$3(state,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560),((function (text,state,matches,temp__5751__auto__){
return (function (p1__8850_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc,p1__8850_SHARP_,matches);
});})(text,state,matches,temp__5751__auto__))
);
text = G__8914;
state = G__8915;
...
var vec__8882 = (((transformer === cljs.core.identity))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [buf,cur_state], null):(function (){var vec__8886 = (function (){var G__8889 = clojure.string.join.cljs$core$IFn$_invoke$arity$1(buf);
var G__8890 = cur_state;
return (transformer.cljs$core$IFn$_invoke$arity$2 ? transformer.cljs$core$IFn$_invoke$arity$2(G__8889,G__8890) : transformer.call(null,G__8889,G__8890));
})();
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8886,(0),null);
var new_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8886,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.seq(s),new_state], null);
})());
var new_buf = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8882,(0),null);
var new_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8882,(1),null);
var G__8929 = cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(out,cljs.core.seq(open),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new_buf,cljs.core.seq(close)], 0)));
var G__8930 = cljs.core.PersistentVector.EMPTY;
var G__8931 = cljs.core.rest(tokens);
var G__8932 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(new_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),false);
out = G__8929;
buf = G__8930;
tokens = G__8931;
cur_state = G__8932;
...
var G__8933 = out;
var G__8934 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.first(tokens));
var G__8935 = cljs.core.rest(tokens);
var G__8936 = cur_state;
out = G__8933;
buf = G__8934;
tokens = G__8935;
cur_state = G__8936;
...
var G__8937 = out;
var G__8938 = buf;
var G__8939 = cljs.core.rest(tokens);
var G__8940 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cur_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),true);
out = G__8937;
buf = G__8938;
tokens = G__8939;
cur_state = G__8940;
...
var G__8941 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(out,cljs.core.first(tokens));
var G__8942 = buf;
var G__8943 = cljs.core.rest(tokens);
var G__8944 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cur_state,new cljs.core.Keyword(null,"in-tag?","in-tag?",1693672911),markdown.common.open_html_tags(new cljs.core.Keyword(null,"in-tag?","in-tag?",1693672911).cljs$core$IFn$_invoke$arity$1(cur_state),cljs.core.first(tokens)));
out = G__8941;
buf = G__8942;
tokens = G__8943;
cur_state = G__8944;
...
var num_hashes = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__8899_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(" ",p1__8899_SHARP_);
}),cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__8900_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",p1__8900_SHARP_)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(" ",p1__8900_SHARP_)));
}),cljs.core.seq(text))));
if((num_hashes > (0))){
return num_hashes;
} else {
