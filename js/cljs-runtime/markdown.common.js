...
var len__4864__auto___9013 = arguments.length;
var i__4865__auto___9014 = (0);
while(true){
if((i__4865__auto___9014 < len__4864__auto___9013)){
args__4870__auto__.push((arguments[i__4865__auto___9014]));

var G__9015 = (i__4865__auto___9014 + (1));
i__4865__auto___9014 = G__9015;
continue;
} else {
}
break;
...
var G__9016 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (text,state,matches,temp__5751__auto__){
return (function (s,r){
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560).cljs$core$IFn$_invoke$arity$1(state),p1__8973_SHARP_,p1__8973_SHARP_);
});})(text,state,matches,temp__5751__auto__))
);
});})(text,state,matches,temp__5751__auto__))
,text,matches);
var G__9017 = cljs.core.update.cljs$core$IFn$_invoke$arity$3(state,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560),((function (text,state,matches,temp__5751__auto__){
return (function (p1__8974_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc,p1__8974_SHARP_,matches);
});})(text,state,matches,temp__5751__auto__))
);
text = G__9016;
state = G__9017;
...
var vec__8991 = (((transformer === cljs.core.identity))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [buf,cur_state], null):(function (){var vec__8994 = (function (){var G__8997 = clojure.string.join.cljs$core$IFn$_invoke$arity$1(buf);
var G__8998 = cur_state;
return (transformer.cljs$core$IFn$_invoke$arity$2 ? transformer.cljs$core$IFn$_invoke$arity$2(G__8997,G__8998) : transformer.call(null,G__8997,G__8998));
})();
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8994,(0),null);
var new_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8994,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.seq(s),new_state], null);
})());
var new_buf = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8991,(0),null);
var new_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8991,(1),null);
var G__9021 = cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(out,cljs.core.seq(open),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new_buf,cljs.core.seq(close)], 0)));
var G__9022 = cljs.core.PersistentVector.EMPTY;
var G__9023 = cljs.core.rest(tokens);
var G__9024 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(new_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),false);
out = G__9021;
buf = G__9022;
tokens = G__9023;
cur_state = G__9024;
...
var G__9028 = out;
var G__9029 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.first(tokens));
var G__9030 = cljs.core.rest(tokens);
var G__9031 = cur_state;
out = G__9028;
buf = G__9029;
tokens = G__9030;
cur_state = G__9031;
...
var G__9032 = out;
var G__9033 = buf;
var G__9034 = cljs.core.rest(tokens);
var G__9035 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cur_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),true);
out = G__9032;
buf = G__9033;
tokens = G__9034;
cur_state = G__9035;
...
var G__9036 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(out,cljs.core.first(tokens));
var G__9037 = buf;
var G__9038 = cljs.core.rest(tokens);
var G__9039 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cur_state,new cljs.core.Keyword(null,"in-tag?","in-tag?",1693672911),markdown.common.open_html_tags(new cljs.core.Keyword(null,"in-tag?","in-tag?",1693672911).cljs$core$IFn$_invoke$arity$1(cur_state),cljs.core.first(tokens)));
out = G__9036;
buf = G__9037;
tokens = G__9038;
cur_state = G__9039;
...
var num_hashes = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__9009_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(" ",p1__9009_SHARP_);
}),cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__9010_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",p1__9010_SHARP_)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(" ",p1__9010_SHARP_)));
}),cljs.core.seq(text))));
if((num_hashes > (0))){
return num_hashes;
} else {
