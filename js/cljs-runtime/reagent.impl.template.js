...
var G__8636 = o;
reagent.impl.template.goog$module$goog$object.set(G__8636,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__8711__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__8711 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__8712__i = 0, G__8712__a = new Array(arguments.length -  0);
while (G__8712__i < G__8712__a.length) {G__8712__a[G__8712__i] = arguments[G__8712__i + 0]; ++G__8712__i;}
  args = new cljs.core.IndexedSeq(G__8712__a,0,null);
} 
return G__8711__delegate.call(this,args);};
G__8711.cljs$lang$maxFixedArity = 0;
G__8711.cljs$lang$applyTo = (function (arglist__8713){
var args = cljs.core.seq(arglist__8713);
return G__8711__delegate(args);
});
...
var G__8638 = o;
reagent.impl.template.goog$module$goog$object.set(G__8638,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__8718__i < G__8718__a.length) {G__8718__a[G__8718__i] = arguments[G__8718__i + 0]; ++G__8718__i;}
  args = new cljs.core.IndexedSeq(G__8718__a,0,null);
} 
...
var G__8643 = props;
var G__8643__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8643,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__8643);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8643__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__8646 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8646,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__8646;
}
})(),id_class);
...
var G__8650 = (cljs.core.count(argv) - first_child);
switch (G__8650) {
case (0):
...
var vec__8655 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8655,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8655,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8655,(2),null);
...
var temp__5757__auto___8748 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___8748 == null)){
} else {
var key_8753 = temp__5757__auto___8748;
(jsprops.key = key_8753);
}
...
var temp__5757__auto___8778 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___8778 == null)){
} else {
var key_8779 = temp__5757__auto___8778;
(jsprops.key = key_8779);
}
...
var temp__5757__auto___8780 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___8780 == null)){
} else {
var key_8781 = temp__5757__auto___8780;
(jsprops.key = key_8781);
}
...
var temp__5757__auto___8784 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___8784 == null)){
} else {
var key_8785 = temp__5757__auto___8784;
(jsprops.key = key_8785);
}
...
var temp__5757__auto___8786 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___8786 == null)){
} else {
var key_8787 = temp__5757__auto___8786;
(jsprops.key = key_8787);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__8663_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__8663_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__8669 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8669,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8669,(1),null);
...
break;
default:
var G__8794 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__8795 = compiler;
v = G__8794;
compiler = G__8795;
continue;
...
var G__8678 = tag;
var G__8678__$1 = (((G__8678 instanceof cljs.core.Keyword))?G__8678.fqn:null);
switch (G__8678__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template8691 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template8691 = (function (opts,id,fn_to_element,parse_fn,meta8692){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta8692 = meta8692;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template8691.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_8693,meta8692__$1){
var self__ = this;
var _8693__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template8691(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta8692__$1));
}));

(reagent.impl.template.t_reagent$impl$template8691.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_8693){
var self__ = this;
var _8693__$1 = this;
return self__.meta8692;
}));

(reagent.impl.template.t_reagent$impl$template8691.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template8691.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template8691.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template8691.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template8691.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template8691.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta8692","meta8692",-2106947656,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template8691.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template8691.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template8691");

(reagent.impl.template.t_reagent$impl$template8691.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template8691");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template8691.
 */
reagent.impl.template.__GT_t_reagent$impl$template8691 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template8691(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta8692){
return (new reagent.impl.template.t_reagent$impl$template8691(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta8692));
});

}

return (new reagent.impl.template.t_reagent$impl$template8691(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
