...
var seq__10269_10309 = cljs.core.seq(lines);
var chunk__10270_10310 = null;
var count__10271_10311 = (0);
var i__10272_10312 = (0);
while(true){
if((i__10272_10312 < count__10271_10311)){
var line_10313 = chunk__10270_10310.cljs$core$IIndexed$_nth$arity$2(null,i__10272_10312);
markdown.links.parse_reference_link(line_10313,references);


var G__10314 = seq__10269_10309;
var G__10315 = chunk__10270_10310;
var G__10316 = count__10271_10311;
var G__10317 = (i__10272_10312 + (1));
seq__10269_10309 = G__10314;
chunk__10270_10310 = G__10315;
count__10271_10311 = G__10316;
i__10272_10312 = G__10317;
continue;
} else {
var temp__5753__auto___10318 = cljs.core.seq(seq__10269_10309);
if(temp__5753__auto___10318){
var seq__10269_10319__$1 = temp__5753__auto___10318;
if(cljs.core.chunked_seq_QMARK_(seq__10269_10319__$1)){
var c__4679__auto___10320 = cljs.core.chunk_first(seq__10269_10319__$1);
var G__10321 = cljs.core.chunk_rest(seq__10269_10319__$1);
var G__10322 = c__4679__auto___10320;
var G__10323 = cljs.core.count(c__4679__auto___10320);
var G__10324 = (0);
seq__10269_10309 = G__10321;
chunk__10270_10310 = G__10322;
count__10271_10311 = G__10323;
i__10272_10312 = G__10324;
continue;
} else {
var line_10325 = cljs.core.first(seq__10269_10319__$1);
markdown.links.parse_reference_link(line_10325,references);


var G__10326 = cljs.core.next(seq__10269_10319__$1);
var G__10327 = null;
var G__10328 = (0);
var G__10329 = (0);
seq__10269_10309 = G__10326;
chunk__10270_10310 = G__10327;
count__10271_10311 = G__10328;
i__10272_10312 = G__10329;
continue;
}
} else {
}
...
var seq__10273_10330 = cljs.core.seq(lines);
var chunk__10274_10331 = null;
var count__10275_10332 = (0);
var i__10276_10333 = (0);
while(true){
if((i__10276_10333 < count__10275_10332)){
var line_10334 = chunk__10274_10331.cljs$core$IIndexed$_nth$arity$2(null,i__10276_10333);
markdown.links.parse_footnote_link(line_10334,footnotes);


var G__10335 = seq__10273_10330;
var G__10336 = chunk__10274_10331;
var G__10337 = count__10275_10332;
var G__10338 = (i__10276_10333 + (1));
seq__10273_10330 = G__10335;
chunk__10274_10331 = G__10336;
count__10275_10332 = G__10337;
i__10276_10333 = G__10338;
continue;
} else {
var temp__5753__auto___10339 = cljs.core.seq(seq__10273_10330);
if(temp__5753__auto___10339){
var seq__10273_10340__$1 = temp__5753__auto___10339;
if(cljs.core.chunked_seq_QMARK_(seq__10273_10340__$1)){
var c__4679__auto___10341 = cljs.core.chunk_first(seq__10273_10340__$1);
var G__10342 = cljs.core.chunk_rest(seq__10273_10340__$1);
var G__10343 = c__4679__auto___10341;
var G__10344 = cljs.core.count(c__4679__auto___10341);
var G__10345 = (0);
seq__10273_10330 = G__10342;
chunk__10274_10331 = G__10343;
count__10275_10332 = G__10344;
i__10276_10333 = G__10345;
continue;
} else {
var line_10346 = cljs.core.first(seq__10273_10340__$1);
markdown.links.parse_footnote_link(line_10346,footnotes);


var G__10347 = cljs.core.next(seq__10273_10340__$1);
var G__10348 = null;
var G__10349 = (0);
var G__10350 = (0);
seq__10273_10330 = G__10347;
chunk__10274_10331 = G__10348;
count__10275_10332 = G__10349;
i__10276_10333 = G__10350;
continue;
}
} else {
}
...
var vec__10277 = markdown.transformers.parse_metadata_headers(lines);
var metadata = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10277,(0),null);
var num_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10277,(1),null);
...
var _STAR_substring_STAR__orig_val__10280 = markdown.common._STAR_substring_STAR_;
var _STAR_formatter_STAR__orig_val__10281 = markdown.transformers._STAR_formatter_STAR_;
var _STAR_substring_STAR__temp_val__10282 = (function (s,n){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.drop.cljs$core$IFn$_invoke$arity$2(n,s));
});
var _STAR_formatter_STAR__temp_val__10283 = markdown.core.format;
(markdown.common._STAR_substring_STAR_ = _STAR_substring_STAR__temp_val__10282);

(markdown.transformers._STAR_formatter_STAR_ = _STAR_formatter_STAR__temp_val__10283);
...
var vec__10284 = (cljs.core.truth_(new cljs.core.Keyword(null,"parse-meta?","parse-meta?",-1938948742).cljs$core$IFn$_invoke$arity$1(params__$1))?markdown.core.parse_metadata(lines):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,lines], null));
var metadata = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10284,(0),null);
var lines__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10284,(1),null);
var transformer = markdown.core.init_transformer(params__$1);
var G__10290_10351 = lines__$1;
var vec__10291_10352 = G__10290_10351;
var seq__10292_10353 = cljs.core.seq(vec__10291_10352);
var first__10293_10354 = cljs.core.first(seq__10292_10353);
var seq__10292_10355__$1 = cljs.core.next(seq__10292_10353);
var line_10356 = first__10293_10354;
var more_10357 = seq__10292_10355__$1;
...
var G__10290_10359__$1 = G__10290_10351;
var state_10360__$1 = state_10358;
while(true){
var vec__10297_10361 = G__10290_10359__$1;
var seq__10298_10362 = cljs.core.seq(vec__10297_10361);
var first__10299_10363 = cljs.core.first(seq__10298_10362);
var seq__10298_10364__$1 = cljs.core.next(seq__10298_10362);
var line_10365__$1 = first__10299_10363;
var more_10366__$1 = seq__10298_10364__$1;
...
}finally {(markdown.transformers._STAR_formatter_STAR_ = _STAR_formatter_STAR__orig_val__10281);

(markdown.common._STAR_substring_STAR_ = _STAR_substring_STAR__orig_val__10280);
}});
...
/** @this {Function} */
(markdown.core.md__GT_html.cljs$lang$applyTo = (function (seq10300){
var G__10301 = cljs.core.first(seq10300);
var seq10300__$1 = cljs.core.next(seq10300);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10301,seq10300__$1);
}));
