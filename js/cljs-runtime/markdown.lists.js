...
return clojure.string.join.cljs$core$IFn$_invoke$arity$1((function (){var iter__4652__auto__ = (function markdown$lists$close_lists_$_iter__10131(s__10132){
return (new cljs.core.LazySeq(null,(function (){
var s__10132__$1 = s__10132;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__10132__$1);
if(temp__5753__auto__){
var s__10132__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__10132__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__10132__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__10134 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__10133 = (0);
while(true){
if((i__10133 < size__4651__auto__)){
var vec__10135 = cljs.core._nth(c__4650__auto__,i__10133);
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10135,(0),null);
cljs.core.chunk_append(b__10134,["</li></",cljs.core.name(list_type),">"].join(''));

var G__10160 = (i__10133 + (1));
i__10133 = G__10160;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__10134),markdown$lists$close_lists_$_iter__10131(cljs.core.chunk_rest(s__10132__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__10134),null);
}
} else {
var vec__10140 = cljs.core.first(s__10132__$2);
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10140,(0),null);
return cljs.core.cons(["</li></",cljs.core.name(list_type),">"].join(''),markdown$lists$close_lists_$_iter__10131(cljs.core.rest(s__10132__$2)));
}
} else {
return null;
}
...
var lists_to_close = cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__10143_SHARP_){
return (cljs.core.second(p1__10143_SHARP_) > num_indents);
...
var vec__10146 = cljs.core.last(new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10146,(0),null);
var indents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10146,(1),null);
...
var vec__10150 = cljs.core.last(new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10150,(0),null);
var indents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10150,(1),null);
var num_indents = cljs.core.count(cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core._EQ_," "),text));
...
markdown.lists.li = (function markdown$lists$li(text,p__10154){
var map__10155 = p__10154;
var map__10155__$1 = cljs.core.__destructure_map(map__10155);
var state = map__10155__$1;
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10155__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var last_line_empty_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10155__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10155__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10155__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
